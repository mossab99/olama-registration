...
if ( $action === 'print_receipt' && $payment_id ) {
    ...
    <head>
        ...
        <style>
            body { font-family: 'Tajawal', sans-serif; margin: 50px; color: #1a1a2e; background:#fcfcfc; }
            .receipt-wrap { max-width: 600px; margin: 0 auto; border: 2px solid #E8920A; padding: 40px; border-radius: 12px; background:#fff; position:relative; box-shadow:0 4px 15px rgba(232,146,10,0.15); }
            .receipt-wrap::before { content:''; position:absolute; left:0; top:0; width:100%; height:8px; background:linear-gradient(90deg, #E8920A, #FFA726); }
            .header-table { width: 100%; border-collapse: collapse; margin-bottom: 30px; border-bottom: 2px solid #f0f0f0; padding-bottom:15px; }
            .logo-title { font-size: 22px; font-weight: 800; color: #E8920A; }
            .receipt-title { font-size: 26px; font-weight: 800; text-align: left; color: #1a1a2e; }
            .receipt-no { font-size:14px; color:#6B7280; font-weight:700; text-align:left; margin-top:4px; }
            .content-table { width:100%; border-collapse: collapse; margin-bottom:30px; }
            .content-table td { padding:10px 6px; border-bottom:1px dashed #f0f0f0; font-size:14px; }
            .label { font-weight: 700; color: #6B7280; width: 140px; }
            .amount-box { background: #FFF3E0; border: 1.5px solid #E0C090; border-radius: 8px; padding: 15px; text-align: center; margin-bottom: 30px; }
            .amount-val { font-size: 28px; font-weight: 800; color: #C4780A; }
            .sign-table { width:100%; border-collapse: collapse; margin-top:40px; }
            .sign-table td { text-align:center; font-size:14px; width:50%; }
            .footer { margin-top:40px; text-align:center; font-size:11px; color:#999; border-top:1px solid #eee; padding-top:12px; }
            @media print {
                body { background:none; margin:0; }
                .receipt-wrap { border:none; box-shadow:none; padding:20px; }
    ...
    <body>
        <div class="no-print" style="max-width: 600px; margin: 0 auto 20px; text-align: left;">
            <button onclick="window.print();" style="padding: 10px 20px; font-weight: 700; background: #E8920A; color:#fff; border:none; border-radius:4px; cursor:pointer;">طباعة السند</button>
        </div>
        <div class="receipt-wrap">
            ...
            <div class="amount-box">
                <div style="font-size:12px; font-weight:700; color:#C4780A; margin-bottom:4px;"><?php esc_html_e( 'المبلغ المستلم', 'olama-registration' ); ?></div>
                <div class="amount-val"><?php echo esc_html( number_format( $payment->amount, 2 ) ); ?> د.أ</div>
            </div>
            ...
            <table class="sign-table">
                <tr>
                    <td>
                        <div style="font-weight:700; color:#6B7280;"><?php esc_html_e( 'المستلم (أمين الصندوق)', 'olama-registration' ); ?></div>
                        <div style="margin-top:40px; font-weight:700;"><?php echo esc_html( $received_by_name ?: 'المحاسب المسؤول' ); ?></div>
                    </td>
                    <td>
                        <div style="font-weight:700; color:#6B7280;"><?php esc_html_e( 'توقيع ولي الأمر', 'olama-registration' ); ?></div>
                        <div style="margin-top:40px; border-bottom:1px dashed #ccc; width:150px; margin-right:auto; margin-left:auto;"></div>
                    </td>
                </tr>
            </table>
